...
<li>
<h3>ジャンル</h3>
<input type="checkbox" name='genre[]' value='飲食店'>飲食店
<input type="checkbox" name='genre[]' value='居酒屋'>居酒屋
<input type="checkbox" name='genre[]' value='カフェ'>カフェ
<input type="checkbox" name='genre[]' value='スイーツ'>スイーツ
</li>
<li>
<h3>お店の名前</h3>
